...
class CancelarPost extends BaseController
{
    public function index()
    {
        ...
        $empresa = $modal->getEmpresa($nota['empresa_id']);
...
//    AGUARDA CERTIFICADO DIGITAL
    ...
    try {
        $chave = $nota['ide_id']; //  CHAVE AUTORIZADA
        $justificativa = $this->request->getGetPost('justificativa'); //JUSTIFICATIVA
        $nProt = $nota['nProt']; //NUMERO PROTOCOLO AUTORIZADA
