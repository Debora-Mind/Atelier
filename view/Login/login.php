...
<form action="/realiza-login"
    ...
    <div class="mb-5">
        ...
        <input type="text" class="form-control mb-3" id="senha" name="senha" aria-describedby="basic-addon3">
    </div>
    <div>
        <?php if(isset($erro)):?>
        <span><?= $erro['mensage'] ?></span>
        <?php endif;?>
    </div>
    <div class="mb-5 d-grid">
        <button class="btn btn-primary btn-lg mb-5" type="button">Login</button>
    </div>
</form>
